    ...
    <div className='w-full bg-gray-100 p-4'>
      {
            ...
            <div className='w-full h-52 bg-white col-span-1 p-4 flex items-center'>
              <div className='space-y-2'>
        ...
        ) : <motion.div initial={{y: 70, opacity:0}} animate={{ y:0 , opacity: 1}} transition={{ delay:0.5, duration: 0.5}} className='flex w-full py-12 items-center justify-center'>
                ...
                <div className='bg-white text-center p-5 rounded-md w-96 shadow-lg'>
                    <h4 className='text-xl font-titleFont font-bold '>Your Cart feels lonely</h4>
                    <p className='text-sm'>
                      {" "}
                      Your Shopping cart lives to serve. Give it purpose - fill it with books, electronics, videos, etc. and make it happy.</p>
                    <Link to="/">
                        <button className='bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-600 p-2 px-4 text-base font-semibold rounded-md mt-5' >Continue Shopping</button>
                    </Link>
                </div>
        </motion.div>
      }
